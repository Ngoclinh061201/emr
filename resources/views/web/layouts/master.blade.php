...
<body id="body">
  <header class="BgScrollEffect" style="height:220px">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="content">
            ...
            {{-- <div class="text" style="line-height: 1.55; width:900px">Theo thống kê của Viện Răng Hàm Mặt Trung ương, Việt Nam có trên 90% dân số mắc các bệnh về răng miệng như sâu răng, viêm nướu răng, viêm quanh răng và 75 % dân số bị sâu răng, trong đó tỷ lệ người lớn có bệnh viêm nướu và viêm quanh răng là trên 90%
            </div> --}}
