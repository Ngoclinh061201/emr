...
<body>
    ...
    <header class="BgScrollEffect "style = " height: 170px" >
        <div class="BackgroundImage"></div>
        
        <!-- Include navbar -->
        @include('web.layouts.navbar')

        {{-- <div class="container WrapContent" style="height: :100px">
    ...
    <section class="MakeAppointment" >
        <div class="container WrapHeadingContent" >
            <div class="HeadingContent  ElementScrollEffect left">
                ...
                <h5 class="heading--sub">Lựa chọn dịch vụ bạn mong muốn và nhận cuộc gọi từ lễ tân để xác nhận thông tin</h5>
                <span class="dash"></span>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input id="fullname" name="name" value="{{ old('name') }}" type="text" placeholder="VD: Ngọc Linh" class="form-control">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="more_info" id="form-field-message" cols="60%" rows="2" placeholder="Nội dung" class="form-control">{{ old('more_info') }}</textarea>
                                    </div>
    ...
    <div class="modal fade" id="myAppointment">
        ...
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
            <form action="{{ route('appointment.store') }}" method="POST" class="form" id="form-1">
                @csrf
                <div class="spacer"></div>
